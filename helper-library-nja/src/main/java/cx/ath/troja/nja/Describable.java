...
/**
 * Describable instances get logged (times executed and total time spent executing) when executed by
 * FriendlyScheduledThreadPoolExecutor.
 */
public interface Describable extends Runnable {

	/**
	 * Get the description to log this instance with
	 */
