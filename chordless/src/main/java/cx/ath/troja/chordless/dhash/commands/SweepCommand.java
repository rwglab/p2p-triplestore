...
public abstract class SweepCommand extends ForwardableCommand {

	public SweepCommand(ServerInfo s) {
		super(s);
	}

	@Override
	protected boolean forwardable(DHash dhash) {
		return dhash.getSuccessor().getIdentifier().compareTo(dhash.getIdentifier()) > 0;
	}
