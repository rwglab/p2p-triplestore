...
public class DSet<V> extends DHashMap<V, Object> implements DCollection<V> {
	...
	public static class DSetIterator<V> implements DCollection.DIterator<V> {
		private DHashMap.DHashMapIterator<V, Object> backend;

		private Identifier parent;

		public DSetIterator(Identifier p, DHashMap.DHashMapIterator<V, Object> b) {
			backend = b;
			parent = p;
		}
	...
	public DCollection.DIterator<V> iterator() {
		return new DSetIterator<V>(getIdentifier(), super.entryIterator());
	}
	...
	public DCollection.DIterator<V> iterator(Identifier start) {
		return new DSetIterator<V>(getIdentifier(), super.entryIterator(start));
	}
